...
class InstrumentCategory(IntEnum):
    UNKNOWN = 0,
    PIANO = 1,
...
def category_from_program(program : int):
    return InstrumentCategory(int(((program-1)/8)+1))
...
def instrument_from_program(program):
    return Instrument(program+1)
